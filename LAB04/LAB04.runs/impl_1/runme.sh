...
HD_PWD='D:/Janovec/LAB04/LAB04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vectors.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vectors.tcl -notrace
