...
HD_PWD='D:/Janovec/LAB05/LAB05.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log displays.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source displays.tcl -notrace
